  ...
  return (
    <div className="">
      ...
      {options.map((option) => (
        <form key={option.id}>
          <dl className="mb-8">
            <dt className="mb-3 text-sm font-semibold uppercase tracking-wide">{option.name}</dt>
                ...
                return (
                  <button
                    ...
                    className={clsx(
                      ...
                      {
                        'cursor-default bg-gunMetal-200/100 px-4 font-semibold text-txtsec sm:px-6':
                          isActive,
                        'transition-all duration-300 ease-in-out': !isActive && isAvailableForSale,
                        'relative z-10 cursor-not-allowed overflow-hidden bg-neutral-100 text-neutral-500 ring-1 ring-neutral-300 before:absolute before:inset-x-0 before:-z-10 before:h-px before:-rotate-45 before:bg-neutral-300 before:transition-transform dark:bg-neutral-900 dark:text-neutral-400 dark:ring-neutral-700 before:dark:bg-neutral-700':
                          !isAvailableForSale
